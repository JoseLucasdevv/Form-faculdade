...
var Validate = /*#__PURE__*/function () {
  function Validate() {
    ...
    this.inputs = [this.inputUser, this.inputPassword, this.inputRepeatPassword, this.inputEmail, this.inputAddress, this.inputCheckbox, this.btn];
    this.verificate();
  }
  _createClass(Validate, [{
    ...
    value: function removeSpan(input) {
      if (input.nextElementSibling.classList.contains("error") || input.nextElementSibling.classList.contains("sucess")) {
